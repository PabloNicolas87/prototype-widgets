...
const KpiWidgetWrapper: FC<WidgetProps> = (props) => {
  return KpiWidget({ data: props.data as never, title: props.title, size: props.size });
};

const BarChartWidgetWrapper: FC<WidgetProps> = (props) => {
  return BarChartWidget({ data: props.data as never, title: props.title, size: props.size });
};

const LineChartWidgetWrapper: FC<WidgetProps> = (props) => {
  return LineChartWidget({ data: props.data as never, title: props.title, size: props.size });
};

const PieChartWidgetWrapper: FC<WidgetProps> = (props) => {
  return PieChartWidget({ data: props.data as never, title: props.title, size: props.size });
};

const TableWidgetWrapper: FC<WidgetProps> = (props) => {
  return TableWidget({ data: props.data as never, title: props.title, size: props.size });
};
